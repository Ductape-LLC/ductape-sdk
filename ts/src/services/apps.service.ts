...
export const updateApp = async (payload: any) => {
    try {
...
export const fetchWorkspaceApps = async (payload: any) => {
    try {
...
export const fetchApp = async (payload: any) => {
    try {
...
export const fetchAppEnv = async (payload: any) => {
    try {
...
export const updateAppEnv = async (payload: any) => {
    try {
...
export const createAppEnv = async (payload: any) => {
    try {
...
export const createAppFaq = async (payload: any) => {
    try {
...
export const updateAppFaq = async (payload: any) => {
    try {
...
export const deleteAppFaq = async (payload: any) => {
    try {
...
export const createAppSetup = async (payload: any) => {
    try {
...
export const fetchAppSetups = async (payload: any) => {
    try {
        const { token, app_id, public_key, user_id } = payload;
...
export const fetchAppSetupsEnvs = async (payload: any) => {
    try {
...
export const fetchSetup = async (payload: any) => {
    try {
...
export const fetchDomains = async (payload: any) => {
    try {
