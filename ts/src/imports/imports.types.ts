import { IAppAction, IAppFolders } from "../types/appBuilder.types";

export interface IFoldersAndActions { actions: Array<IAppAction>, folders: Array<IAppFolders> }
